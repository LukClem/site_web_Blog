...
<body>
 ...
 <?php include_once 'includes/menu.inc.php'; ?>
  ...
  <div class="form-group">
    <input type="text" name="recherche" class="form-control" required placeholder="Rechercher">
...
<?php include_once 'includes/footer.inc.php'; ?>
 ...
 <?php } elseif($nb_result === 0){
     echo "Désolé, aucun résultat";
 } ?>
